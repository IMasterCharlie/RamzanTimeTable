                ...
                <div className="text-center md:text-right space-y-2">
                  <div className="flex flex-col items-center md:items-end gap-1">
                    ...
                    >
                      ...
                      <span>+91 83096 64356</span>
                    </a>
                    <div className="flex flex-col md:items-end text-xs text-slate-500 mt-2">
                      <p>Owned by <span className="text-amber-500 font-bold">Abdul Hakeem</span></p>
                      <p>Developed by <span className="text-slate-400">Mohammed Mehraj</span></p>
                    </div>
                  </div>
                </div>
              </div>
